<script>
    import { GOLD, SILVER, PLATIN } from '../../constants/membership-colors.js';
    import { ACTIVE } from '../../constants/active-user';
...
<div class="user-details-content ... ">
    <div class="w-3/4 m-auto ...">
        <div class="flex justify-center mt-8 pb-3 ...">
            <div
                class=" {user.membership === GOLD
                    ? 'bg-yellow-400'
                    : user.membership === SILVER
                    ? 'bg-gray-400'
                    : user.membership === PLATIN
                    ? 'bg-purple-400'
                    : 'bg-white-300'} user-details_avatar_membership_cicle"
            />
            <img
                class=" m-px rounded-full user-details-photo"
                src="./../../static/medium/{user.avatar}"
                alt="{user.avatar} "
            />
            <div class=" {user.active === ACTIVE ? 'user-details_avatar_active_cicle' : 'user-details-inactive'}" />
        </div>
        ...
        <div class="table w-full user-details-table-contents pt-2 ... ">
            ...
            <div class="pb-3 table-row ...">
                ...
                <a href="#" rel="email" class="text-left table-cell e-mail_color ...">{user.email_address}</a>
            </div>
        </div>
